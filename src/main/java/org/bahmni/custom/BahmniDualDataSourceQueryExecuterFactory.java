 ...
 *
 */
public class BahmniDualDataSourceQueryExecuterFactory implements JRQueryExecuterFactory {
	...
	public JRQueryExecuter createQueryExecuter(JRDataset dataset, Map parameters)
		...
		return new BahmniDualDataSourceQueryExecuter(dataset, parameters);
	}
